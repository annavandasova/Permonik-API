...
//        Integer groupedSpecimens = countPage.getGroupResult(ID_ISSUE_FIELD).getGroupsCount();
    ...
    public SpecimensWithFacetsDTO getSpecimensWithFacetsByMetaTitle(String idTitle, Integer offset, Integer rows, String facets, String view) throws JsonProcessingException {
        ...
        if(specimenFacets.getDateStart() > 0 && specimenFacets.getDateEnd() > 0){
            ...
            criteria
                .and(PUBLICATION_DATE_FIELD).greaterThanEqual(specimenFacets.getCalendarDateStart())
                .and(PUBLICATION_DATE_FIELD).lessThanEqual(specimenFacets.getCalendarDateEnd());
        }
